...
class Sms extends MY_Controller {
	...
	function send_sms()
	{
		...
		{
			$url = "https://api.smsblast.id/v2/prem/sendsms.json";
			// $url = "https://smsblast.id/api/sendsingle.json";
			// $url = "http://203.130.242.84:8000/v2/prem/sendsms.json";
		}
		...
		$qry = 'INSERT INTO "sms"."debug"("req", "res") VALUES ('.$this->quotedStr(json_encode($headers)).','.$this->quotedStr($server_output).');';
