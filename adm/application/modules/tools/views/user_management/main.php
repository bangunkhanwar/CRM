<script>
	...
	{
		showProgres();
		$.post(site_url+'tools/user_management/page/'+pg
	...
	function add_new()
	{
		window.location = "<?=base_url()?>tools/user_management/input";
	}
</script>
		...
		<div class="card-header">
		  ...
		  <div class="heading-elements">
			<ul class="list-inline mb-0">
				<li>
					<a  class="btn btn-lg btn-icon btn-light mr-1" href="<?=base_url()?>tools/user_management/input"><i class="ft-plus-square float-left"></i>&nbsp;New</a>		 
				</li>
				<li>
							...
							<fieldset>
							  ...
							  <div class="form-group">
								  <select onchange="loadList(1)" id="order_by_field" name="t_order_by_field" data-placeholder="Select a state..." class="select2 form-control" style="width:90%">
									  <option value="LoginName" selected>User Name</option>
