                ...
                <div class="card-content">
                  <div class="card-body">
                    <form class="form-horizontal form-simple" action="index.html" novalidate>
                      ...
                      <button type="submit" class="btn btn-info btn-lg btn-block"><i class="ft-unlock"></i> Daftar</button>
                    </form>
                  </div>
                  <p class="text-center">Sudah punya akun ? <a href="javascript:void" onclick="tologin()" class="card-link">Login</a></p>
                </div>
              </div>
            </div>
          </div>
