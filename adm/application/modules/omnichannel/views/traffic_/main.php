<script>
	...
	{
		showProgres();
		$.post(site_url+'omnichannel/traffic/page/'+pg
	...
	// function loadListsStock(pg,id_parent)
	// {
		// showProgres();
		// $.post(site_url+'omnichannel/traffic/stockListPage/'+pg+'/'+id_parent
				// ,$('#formFilter').serialize()
				// ,function(result) {
	...
	<div class="col-12">
	  <div class="card">
		<div class="card-header">
		  <h4 class="card-title">Outstanding Order List</h4>
