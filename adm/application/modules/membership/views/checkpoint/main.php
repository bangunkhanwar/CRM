					...
					<div class="form-group row" >
					  ...
					  <div class="col-md-5">
						<div class="input-group">
							...
							<input readonly type="text" id="barcode" class="form-control" placeholder="Card Barcode" maxlength="20" name="t_barcode">
						</div>
					  </div>
					</div> 
				    </div>
							...
							<div class="col-md-5">
								<div class="card p-1 text-white bg-primary">
									...
									<div class="card-body">
										...
										<p class="white mb-0">
											<strong><p class="form-control-static" id="total_point" style="font-size: xx-large;"></p></strong>
										</p>
