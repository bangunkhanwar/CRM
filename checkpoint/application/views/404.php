...
<head>
  ...
  <title>Error 404 - <?=get_myconf('app_name')?>
  </title>
          ...
          <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-md-4 col-10 p-0">
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  <p class="text-muted text-center col-12 py-1">© <?=date('Y')?> <a href="http://elzatta.com"> elhijab </a> By ICT Departement <i class="ft-activity pink"> </i> </p>
