<script>
	...
	{
		showProgres();
		$.post(site_url+'tools/merchant_partner/page/'+pg
		...
		swal({
			...
			buttons: ["No", "Yes"],
			 ...
			 hideProgres();
			    ...
			    if (value) {
						showProgres();
						$.post(site_url+"tools/merchant_partner/delete/"+code
							,{}
							,function(result) {
								if(result['error'])
								{	
	...
	function add_new()
	{
		window.location = "<?=base_url()?>tools/merchant_partner/input";
	}
</script>
	...
	<div class="col-12">
	  <div class="card">
		<div class="card-header">
		  <h4 class="card-title">merchant Partner</h4>
		  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
		  <div class="heading-elements">
			<ul class="list-inline mb-0">
				<li>
					<a  class="btn btn-lg btn-icon btn-light mr-1" href="<?=base_url()?>tools/merchant_partner/input"><i class="ft-plus-square float-left"></i>&nbsp;New</a>		 
				</li>
				<li>
					  ...
					  <form id="formFilter" autocomplete="off">
						<div class="row">
							...
							<fieldset>
							  ...
							  <div class="form-group">
								  <select onchange="loadList(1)" id="order_by_field" name="t_order_by_field" data-placeholder="Select a state..." class="select2 form-control" style="width:90%">
									  <option value="MerchantPartnerCode" selected>User Name</option>
									  <option value="Description">FullName</option>
								  </select>
							  </div>
							</fieldset>
						  </div>
						  ...
						  <div class="col-xl-4 col-lg-12">
							<fieldset>
							  <h5>Search Key
								<small class="text-muted">User Name / Full Name</small>
							  </h5>
							  <div class="form-group">
								<input onkeydown="if(event.keyCode == 13) loadList(1);" id="search_key" name="t_search_key" type="text" class="form-control date-inputmask" id="date-mask" placeholder="Enter Keywoards">
							  </div>
							</fieldset>
						  </div>
						  <div class="col-xl-1 col-lg-12">
