<script>
	...
	{
		showProgres();
		$.post(site_url+'omnichannel/monitoring/page/'+pg
	...
	{
		showProgres();
		$.post(site_url+'omnichannel/monitoring/detailPage/'+pg+'/'+transnum+'/'+storecode
				,$('#formFilter').serialize()
				,function(result) {
                ...
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="info">23.464</h3>
                      <h6>All Checkout Order</h6>
                    </div>
                    <div>
            ...
            <div class="card pull-up">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="success">20.288</h3>
                      <h6>Automatic by Mid Trans</h6>
                    </div>
                    <div>
