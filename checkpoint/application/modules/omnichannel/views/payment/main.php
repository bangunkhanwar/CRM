<script>
	...
	{
		showProgres();
		$.post(site_url+'omnichannel/payment/page/'+pg+'
		            ...
		            <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
		                <div class="heading-elements">
			                <ul class="list-inline mb-0">
                                ...
                                <li><a id = "back" onclick = "back()"><i class="ft-arrow-left"></i></a>
                                </li>
                                <li><a onclick = "reload()" data-action="reload"><i class="ft-rotate-cw"></i></a>
                                </li>
