              ...
              <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                <div class="card-header border-0 pb-0">
                  <div class="card-title text-center">
                    <img src="<?= base_url();?>app-assets/images/logo/logo-temp.png" alt="branding logo">
                  </div>
                  <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
                    <span>Kami akan mengirimkan link untuk reset password.</span>
                  </h6>
                </div>
                ...
                <div class="card-footer border-0">
                  <p class="float-sm-left text-center"><a href="javascript:void" onclick="tologin()" class="card-link">Login</a></p>
                  <p class="float-sm-right text-center">Belum punya akun ? <a href="javascript:void" onclick="register()" class="card-link">Buat Akun</a></p>
                </div>
              </div>
            </div>
          </div>
