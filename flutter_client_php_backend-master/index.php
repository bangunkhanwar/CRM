		...
		if(!empty($operation)){
			...
			if($operation == 'register'){
				...
				if(isset($data -> user ) 
					...
					echo $fun -> getMsgInvalidParam('user tidak ditemukan');
				}
				...
				echo $fun -> getMsgParamNotEmpty($operation);
			}

		}else{
			echo $fun -> getMsgParamNotEmpty('operation tidak boleh kosong');
		}
	} else {

		echo $fun -> getMsgInvalidParam('operation tidak ada');
